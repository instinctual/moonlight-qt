...
void TestOutputTopology::parsesQualificationVector()
{
    ...
    QFile file(QString::fromUtf8(root) + "/tests/protocol/output-topology-v6.json");
    ...
    QCOMPARE(topology.featureFlags & NvOutputTopology::SupportedFeatureFlags, 4095);
...
void TestOutputTopology::rejectsDuplicateIdentity()
{
    ...
    QJsonObject document {
        {"schema_version", 6}, {"feature_flags", 4095}, {"generation", "test"},
