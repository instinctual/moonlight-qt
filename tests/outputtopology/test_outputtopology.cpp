...
void TestOutputTopology::parsesQualificationVector()
{
    ...
    QFile file(QString::fromUtf8(root) + "/tests/protocol/output-topology-v10.json");
    ...
    QCOMPARE(topology.featureFlags & NvOutputTopology::SupportedFeatureFlags, 16383);
...
void TestOutputTopology::rejectsDuplicateIdentity()
{
    ...
    QJsonObject document {
        {"schema_version", 10}, {"feature_flags", 16383}, {"generation", "test"},
