...
void TestOutputTopology::parsesQualificationVector()
{
    ...
    QFile file(QString::fromUtf8(root) + "/tests/protocol/output-topology-v11.json");
    ...
    QCOMPARE(topology.featureFlags & NvOutputTopology::SupportedFeatureFlags, 32767);
...
void TestOutputTopology::rejectsDuplicateIdentity()
{
    ...
    QJsonObject document {
        {"schema_version", 11}, {"feature_flags", 32767}, {"generation", "test"},
