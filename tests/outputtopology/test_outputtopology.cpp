...
void TestOutputTopology::parsesQualificationVector()
{
    ...
    QFile file(QString::fromUtf8(root) + "/tests/common/protocol/output-topology-v16.json");
    ...
    QCOMPARE(topology.featureFlags & NvOutputTopology::SupportedFeatureFlags, 1048575);
